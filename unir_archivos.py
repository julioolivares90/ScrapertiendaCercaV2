...
FILE_NAME = 'DatosDeTiendaCerca.xlsx' #nombre del archivo de excel que contiene los datos en varias hojas
MY_SHEET ='Hoja1' #nombre de la una hoja selecconada

FILE_FINAL = 'DatosFinal.xlsx' #nombre del excel final que contendra los datos del archivo anterior
